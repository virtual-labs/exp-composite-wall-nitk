...
function validateAnswer1() {
  ...
  if (!answer) {
    ...
    correctAnswer.innerHTML =
      '<p><span style=" color: #028102;">Correct answer</span> <span style="color: #e7722b;"> R = ' +
      r +
      " <sup>&deg;</sup>C/W</span> ";
    console.log("hi " + r);
  } else if (answer) {
...
function validateAnswer2() {
  ...
  if (!answer) {
    ...
    unit.innerHTML += " <span class='wrong'>&#x2717;</span>";
    correctAnswer.innerHTML =
      '<p><span style=" color: #028102;">Correct answer</span> <span style="color: #e7722b;"> K = ' +
      k +
      " W/m.K</span> ";
  } else if (answer) {
    correctAnswer.classList.add("hide");
